        ...
        <div className='container'>
          ...
          >
            ...
            >
              ...
              <span className='navbar-text text-success text-uppercase font-weight-bold d-none d-lg-inline'>
                გირჩი
              </span>
            </a>
            <button
                ...
                >
                  ...
                  >
                    <li className='nav-item active'>
                      <a
                        className='nav-link py-lg-4 font-weight-bold' href='#'
                      >მთავარი <span className='sr-only'>(current)</span>
                      </a>
                    </li>
                    <li className='nav-item'>
                      <a
                        className='nav-link py-lg-4 font-weight-bold' href='news.html'
                      >სიახლეები
                      </a>
                    </li>
                    <li className='nav-item'>
