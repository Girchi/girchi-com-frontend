                  ...
                  <div className="px-md-8  px-lg-4 px-xl-8 py-3  py-2 py-md-3  py-xl-4">
                    <ul className="nav nav-tabs nav-justified" id="myTab" role="tablist">
                      <li className="nav-item">
                        <a className="nav-link active text-uppercase py-3" id="single-donation-tab" data-toggle="tab" href="#single-donation" role="tab" aria-controls="single-donation" aria-selected="true">ერთჯერადი</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link text-uppercase py-3" id="multiple-donation-tab" data-toggle="tab" href="#multiple-donation" role="tab" aria-controls="multiple-donation" aria-selected="false">მრავალჯერადი</a>
                      </li>
                    </ul>
