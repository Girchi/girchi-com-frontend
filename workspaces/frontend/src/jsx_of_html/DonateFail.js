...
export default function DonateFail (_: {||}): React$Node {
  return (
    <>
      <Header />
                ...
                <div className="col-md-12 col-lg-6">
                  <div className="px-md-8  px-lg-4 px-xl-8 py-2 py-md-3  py-xl-4">
                    <span className="d-block text-center">
                      <i className="icon-error font-size-9 text-danger" />
                    </span>
                    <h5 className="text-uppercase font-weight line-height-1-3 font-weight-bold text-danger text-center mt-3 mb-4 mb-sm-7">
                      ტრანზაქცია უარყოფილია სადეთ თავიდან
                    </h5>
