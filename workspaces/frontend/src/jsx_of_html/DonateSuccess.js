...
export default function DonateSuccess (_: {||}): React$Node {
  return (
    <>
      <Header />
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-12 col-lg-6">
                  <div className="px-md-8  px-lg-4 px-xl-8 py-2 py-md-3  py-xl-4">
                    <span className="d-block text-center">
                      <i className="icon-tick-inside-circle font-size-9 text-success" />
                    </span>
                    <h5 className="text-uppercase font-weight line-height-1-3 font-weight-bold text-success text-center mt-3 mb-3 mb-sm-5">
                      ტრანზაქცია დასრულდა წარმატებით
                    </h5>
                    <div className="w-100 d-flex flex-column align-items-center mb-4 mb-sm-5">
                      <label className="form-label">თქვენ ჩაგერიცხათ</label>
                      <span className="text-success font-size-5 d-inline-flex pt-sm-2 mt-0">
                        <i className="icon-ged" />
                        <span className="ml-1">15 000</span>
                      </span>
                    </div>
                    <a href="settings.html" className="btn btn-success text-uppercase btn-block btn-lg my-3 my-lg-4 text-nowrap">
                      ჩემი პროფილი
                    </a>
                    <a href="donate.html" className="btn btn-warning text-uppercase btn-block btn-lg my-3 my-lg-4 text-nowrap">
                      გადახდის გამეორება
                    </a>
                  </div>
                </div>
