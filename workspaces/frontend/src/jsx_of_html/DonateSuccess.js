              ...
              <div className='row'>
                <div className='col-md-12 col-lg-6'>
                  <div className='px-md-8  px-lg-4 px-xl-8 py-2 py-md-3  py-xl-4'>
                    ...
                    <a href='#' className='btn btn-success text-uppercase btn-block btn-lg my-3 my-lg-4 text-nowrap'>
                      ჩემი პროფილი
                    </a>
                    <a href='#' className='btn btn-warning text-uppercase btn-block btn-lg my-3 my-lg-4 text-nowrap'>
                      გადახდის გამეორება
                    </a>
                  </div>
                </div>
